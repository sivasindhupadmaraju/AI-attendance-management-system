...
from ..schemas.user import UserCreate, UserLogin, UserResponse, Token, ProfileUpdateRequest, PasswordChangeRequest
...
def register(user_in: UserCreate, db: Session = Depends(get_db)):
    ...
    # Check department requirement for teacher
    ...
    if role == "teacher" and not department:
        ...
        department = None  # Admins see everything, no department scope
